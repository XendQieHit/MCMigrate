...
class CollapsibleBox(QtWidgets.QWidget):
    ...
    class SelectionBar(QtWidgets.QFrame):
        ...
        def __init__(self, text: str, parent):
            ...
            self.setMaximumHeight(self.text.height())
            ...
            self.icon.setScale(self.text.height() / (self.icon.boundingRect().height()*3))
            ...
            self.icon_view.setFixedSize(24, self.text.height()-16)
    ...
    class Item(QtWidgets.QWidget):
        def __init__(self, text: str, data, parent: 'CollapsibleBox'=None):
            super().__init__(parent)
            self.data = data
    ...
    selected = QtCore.Signal(object) # 这里的信号的触发直接交给ItemList，就不绑定信号了
